...
この結果，学習・評価データの約 3 割が文脈ありの事例となった．
学習に用いたデータの実件数は train 750{,}029 件，eval 1{,}497 件であった．
...
実際に完了した学習は，
学習データ上限 2{,}000{,}000 件（実データ上限により 750{,}029 件），
epoch 2，バッチ 8，勾配累積 4（実効バッチ 32），最大系列長 128，
学習率 $1\times10^{-4}$，optimizer は AdamW であった．
学習は 46{,}876 ステップで完了している．
学習・評価損失はそれぞれ約 0.96，約 1.0 付近まで低下した（図\ref{fig:flow}）．
